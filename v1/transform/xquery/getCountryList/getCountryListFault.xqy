...
declare function local:getCountryListFault($codeFault as xs:string, 
                                                       $descFault as xs:string,
                                                       $requestPayloadProxy as element() (:: schema-element(cat:getCountryListRq) ::)) as element() (:: schema-element(cat:getCountryListRs) ::) {
...
local:getCountryListFault($codeFault, $descFault, $requestPayloadProxy)