...
declare function local:getCustomerIdTypeListFault($codeFault as xs:string, 
                                                       $descFault as xs:string,
                                                       $requestPayloadProxy as element() (:: schema-element(cat:getCustomerIdTypeListRq) ::)) as element() (:: schema-element(cat:getCustomerIdTypeListRs) ::) {
...
local:getCustomerIdTypeListFault($codeFault, $descFault, $requestPayloadProxy)