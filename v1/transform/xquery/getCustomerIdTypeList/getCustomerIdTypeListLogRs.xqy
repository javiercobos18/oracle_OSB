...
declare function local:getCustomerIdTypeListLogRs($responseDatetime as xs:string, 
    ...
    <log:AuditoryLogResponse>
        ...
        <log:Status>
            {
              if($statusCode = '0' or $statusCode = '00' or $statusCode = '000' or $statusCode = 'false')then
...
local:getCustomerIdTypeListLogRs($responseDatetime, $responseHeader, $responsePayload, $targetRouting, $correlationID,$UUID, $statusCode, $description,$approvalCode)