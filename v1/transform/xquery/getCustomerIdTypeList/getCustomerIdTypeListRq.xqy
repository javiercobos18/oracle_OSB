...
declare function local:getCustomerIdTypeListRq($requestPayloadProxy as element() (:: schema-element(cat:getCustomerIdTypeListRq) ::)) as element() (:: schema-element(sp:InputParameters) ::) {
    <sp:InputParameters>
        {
...
local:getCustomerIdTypeListRq($requestPayloadProxy)