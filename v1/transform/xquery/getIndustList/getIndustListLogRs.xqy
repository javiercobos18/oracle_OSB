...
declare function local:getCustomerProductRelCountLogRs($responseDatetime as xs:string, 
...
local:getCustomerProductRelCountLogRs($responseDatetime, $responseHeader, $responsePayload, $targetRouting, $correlationID,$UUID, $statusCode, $description,$approvalCode)