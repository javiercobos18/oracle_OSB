...
declare function local:getIndustListRq($requestPayloadProxy as element() (:: schema-element(cat:getIndutListRq) ::)) as element() (:: schema-element(sp:InputParameters) ::) {
    <sp:InputParameters>
        {
...
local:getIndustListRq($requestPayloadProxy)
