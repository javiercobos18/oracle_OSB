...
declare function local:getRelationshipListFault($codeFault as xs:string, 
                                                       $descFault as xs:string,
                                                       $requestPayloadProxy as element() (:: schema-element(cat:getRelationshipListRq) ::)) as element() (:: schema-element(cat:getRelationshipListRs) ::) {
...
local:getRelationshipListFault($codeFault, $descFault, $requestPayloadProxy)