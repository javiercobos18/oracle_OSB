...
declare function local:getRelationshipListLogRs($responseDatetime as xs:string, 
...
local:getRelationshipListLogRs($responseDatetime, $responseHeader, $responsePayload, $targetRouting, $correlationID,$UUID, $statusCode, $description,$approvalCode)